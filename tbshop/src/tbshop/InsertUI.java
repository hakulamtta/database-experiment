...
public class InsertUI {
	...
	//将下拉菜单选中值等价于整数
	static int deal(String comboStr)
	{
		if (comboStr.equals("shop"))
			...
			comboValue = 4;
		else if(comboStr.equals("orderList"))
			comboValue = 5;
		else if(comboStr.equals("detail"))
			comboValue = 6;
		else
			comboValue = 0;
		return comboValue;
	...
	private void initialize() {
        ...
        bRefresh.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		String res = "";
        		try {
					res = ConnectSQL.search(comboStr,comboValue);
					ja.setText(res);
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
